            ...
            text: TextSpan(
              ...
              children: <TextSpan>[
                TextSpan(
                  ...
                  style: TextStyle(color: Colors.indigo[700], fontSize: 20, fontWeight: FontWeight.bold, decoration: TextDecoration.none),
                ),
                    TextSpan(
                      text: '   HAVE A BAD DAY\n',
                      style: TextStyle(color: Colors.indigo[700], fontSize: 20, fontWeight: FontWeight.bold,decoration: TextDecoration.none),
...
// }
    ...
    class MyPainter extends CustomPainter{
      ...
      void paint(ui.Canvas canvas, ui.Size size) {
        ...
        recPath.addRRect(
          RRect.fromRectAndRadius(Rect.fromLTWH(size.width / 7, size.height / 2.4, size.width * 3 / 4, size.height/ 4), Radius.circular(22))
        );
