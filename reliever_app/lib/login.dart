      ...
      return new Scaffold(
        body: ListView(
          children: <Widget>[
            ...
            Container(
              child: Positioned( 
                left: 155, top: 180, width: 100, height: 100,
                child: Container(
            ...
            Container(
              child: Positioned( 
                left: 75, top: 310, width: 260, height: 50,
            child: TextField(
              // obscureText: true,
            ...
            Container(
              child: Positioned( 
                left: 75, top: 380, width: 260, height: 50,
            child: TextField(
              obscureText: true,
              decoration: InputDecoration(
                 focusedBorder: OutlineInputBorder(
            ...
            child: RaisedButton(
             ...
             Container(
              ...
              child: Text('You don\'t have any account?\n', style: TextStyle( fontSize: 15, fontWeight: FontWeight.w400, color: Colors.indigo[700])),
            ),
            Container(
            ...
            child: FlatButton(
              ...
              child: Text("Sign Up", style: TextStyle( fontSize: 17, fontWeight: FontWeight.w900, color: Colors.indigo[700])),
            )
            )
  //           TextFormField(
  //             obscureText: true,
  ...
  //           ),
   ...
   class MyPainter extends CustomPainter{
      ...
      void paint(Canvas canvas, Size size) {
        ...
        recPath.addRRect(
          RRect.fromRectAndRadius(Rect.fromLTWH(size.width / 7, size.height / 4.2, size.width * 2.85 / 4, size.height/ 1.5), Radius.circular(22))
        );
