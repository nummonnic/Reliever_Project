...
class ActivityClip extends StatefulWidget {
  ...
  ActivityClip({Key key, this.title, this.rateNote, this.url})
      : super(key: key);
...
class _ActivityState extends State<ActivityClip> {
  ...
  final List<String> numbers = ['Basic Exercise', 'Nature Sound', 'Music'];
  final List<String> urlList = [
    'https://youtu.be/fWRtHhlkbGU',
    'https://youtu.be/Znyj6UBjz0A',
